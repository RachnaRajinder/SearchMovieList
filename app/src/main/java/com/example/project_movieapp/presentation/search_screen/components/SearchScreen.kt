...
import com.example.project_movieapp.presentation.MainViewModel
import com.example.project_movieapp.util.MySpacer
import com.example.project_movieapp.util.Result
import com.example.project_movieapp.util.trimStartEnd
        ...
        Column(
            ...
            TextField(
                ...
                keyboardActions = KeyboardActions(
                    onSearch = {
                        if (title.isNotBlank()) {
                            viewModel.getSearchData(title.trimStartEnd())
